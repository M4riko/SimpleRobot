...
class TestRobot(unittest.TestCase):
    ...
    def test_place00(self):
        self.assertEqual(self._robot.place(0, 0, 0), 1)

    def test_place22(self):
        self.assertEqual(self._robot.place(2, 2, 0), 1)

    def test_placeneg11(self):
        self.assertEqual(self._robot.place(-1, -1, 0), -1)

    def test_place66(self):
        self.assertEqual(self._robot.place(6, 6, 0), -1)

    def test_place111(self):
        self.assertEqual(self._robot.place(1, 1, 1), 1)

    def test_place11n1(self):
        self.assertEqual(self._robot.place(1, 1, -1), -1)

    def test_place11n5(self):
        self.assertEqual(self._robot.place(1, 1, 4), -1)
    ...
    def test_moveNorth(self):
        self._robot.place(1, 1, 0)
        self.assertEqual(self._robot.move(),1 )
